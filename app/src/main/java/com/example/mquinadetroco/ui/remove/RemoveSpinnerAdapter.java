...
public class RemoveSpinnerAdapter extends ArrayAdapter<ItemCoin> {

    private final Context context;
    private final List<ItemCoin> itemCoinList;

    public RemoveSpinnerAdapter(Context context, int textViewResourceId, List<ItemCoin> itemCoinList) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        label.setText(itemCoinList.get(position).getValueFormat() + " qtd: " + itemCoinList.get(position).getAmount());
        return label;
    }
    ...
    public View getDropDownView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        nameTextView.setText(itemCoinList.get(position).getValueFormat() + " qtd: " + itemCoinList.get(position).getAmount());
        return view;
    }
}
